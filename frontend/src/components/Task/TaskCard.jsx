...
const PRIORITY_COLORS = { Hoch: '#e74c3c', Medium: '#f39c12', Niedrig: '#2ecc71' };
...
export default function TaskCard({ task }) {
  ...
  return (
    <div style={{ border: `2px solid ${PRIORITY_COLORS[task.priority]}`, padding: '0.5rem', marginBottom: '0.5rem' }}>
